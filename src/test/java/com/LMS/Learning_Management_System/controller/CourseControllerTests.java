...
class CourseControllerTest {
    ...
    void testAddCourse() {
        ...
        // Setup service mock: now matches signature without instructorId
        doNothing().when(courseService).addCourse(any(Course.class), any(HttpServletRequest.class));
        ...
        verify(courseService, times(1)).addCourse(eq(course), eq(request));
    }
